...
import { saveAs } from 'file-saver';
 ...
 function saveInitialSignature(initialSignature){
  Office.onReady((info) => {
      ...
      if (Office.context.mailbox.item) {
        Office.context.mailbox.item.loadCustomPropertiesAsync((result) => {
          if (result.status === Office.AsyncResultStatus.Succeeded) {
            ...
            customProperties.set("initialSignature", initialSignature);
            ...
            customProperties.saveAsync((saveResult) => {
              if (saveResult.status === Office.AsyncResultStatus.Succeeded) {
                ...
                // console.log("Name:", customProperties.get("name"));
                // console.log("Age:", customProperties.get("age"));
                // console.log("Is Subscribed:", customProperties.get("isSubscribed"));
              } else {
